...
SECRET_KEY = 'django-insecure-q^+*^fl%2ouk7=5$4)mp%c%#dxmz41%+qh2)kg3^*^)l(l!c2m'
...
CELERY_BROKER_URL = 'redis://localhost:6379/0'  # Or another broker
CELERY_RESULT_BACKEND = 'redis://localhost:6379/0'

CELERY_BEAT_SCHEDULE = {
    'subtract-compensation-days-every-day': {
        'task': 'your_app_name.tasks.subtract_compensation_days',
